...
while IFS=$'\t' read -r lang is_seen; do
    python ../lm-evaluation-harness/main.py \
        ...
        --task_name 'sib200_test' \
        --task_args data_dir="/PATH/huggingface/datasets/sib200/$lang",cache_dir='/PATH/huggingface/cache/',download_mode='load_from_disk' \
        --output_dir '/PATH/LLM500/llama2_eval_output/lm-evaluation-harness/' \
        --template_names 'all_templates' \
        --num_fewshot 3 \
        --batch_size 4 \
        --device cuda:0
done < ../lang_list/sib200_lang_list.txt
